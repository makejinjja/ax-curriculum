...
class SingleAgent:
    ...
    def chat(
        ...
        tool_calls_made: list[str] = []
        last_tool_mission: dict | None = None  # generate_mission 결과 직접 추적
        ...
        while iteration < MAX_AGENT_ITERATIONS:
            ...
            if finish == "stop" or not msg.tool_calls:
                ...
                # 에이전트가 태그 형식을 생략해도 도구 결과로 미션 보장
            ...
            for tc in msg.tool_calls:
                ...
                # generate_mission 성공 시: 미션 캐시 + mission_history 업데이트
                if tool_name == "generate_mission" and result.get("mission"):
                    last_tool_mission = result["mission"]
                    m_text = last_tool_mission.get("mission", "")
                    if m_text:
